var favMovies = new Firebase('https://test-c5b4d.firebaseio.com/');
...
function saveToList(event) {
    ...
    if (event.which == 13 || event.keyCode == 13) { // as the user presses the enter key, we will attempt to save the data
       ...
       document.getElementById('favMovies').innerHTML += "<li>" + movieName + "</li>";    
       document.getElementById('movieName').value = '';
       document.getElementById('filters').innerHTML += "<li>" + movieName + "</li>"; 
       document.getElementById('gsc-i-id1').value += movieName + " ";
        }
